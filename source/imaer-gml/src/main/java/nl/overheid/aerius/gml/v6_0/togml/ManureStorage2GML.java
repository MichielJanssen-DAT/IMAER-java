...
import nl.overheid.aerius.gml.v6_0.source.manure.ManureStorageProperty;
...
class ManureStorage2GML extends SpecificSource2GML<ManureStorageEmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource convert(final ManureStorageEmissionSource emissionSource) {
    final nl.overheid.aerius.gml.v6_0.source.manure.ManureStorageEmissionSource returnSource =
        new nl.overheid.aerius.gml.v6_0.source.manure.ManureStorageEmissionSource();
  ...
  private nl.overheid.aerius.gml.v6_0.source.manure.CustomManureStorage convert(final CustomManureStorage storage) {
    final nl.overheid.aerius.gml.v6_0.source.manure.CustomManureStorage gmlStorage =
        new nl.overheid.aerius.gml.v6_0.source.manure.CustomManureStorage();
  ...
  private nl.overheid.aerius.gml.v6_0.source.manure.StandardManureStorage convert(final StandardManureStorage storage) {
    final nl.overheid.aerius.gml.v6_0.source.manure.StandardManureStorage gmlStorage =
        new nl.overheid.aerius.gml.v6_0.source.manure.StandardManureStorage();
  ...
  private void setBasicProperties(final AbstractManureStorage storage,
      final nl.overheid.aerius.gml.v6_0.source.manure.AbstractManureStorage gmlStorage) {
