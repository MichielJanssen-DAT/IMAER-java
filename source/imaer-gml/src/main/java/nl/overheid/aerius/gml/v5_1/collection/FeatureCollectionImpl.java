...
import nl.overheid.aerius.gml.v5_1.definitions.DefinitionsProperty;
...
public class FeatureCollectionImpl implements FeatureCollection {
  ...
  private DefinitionsImpl definitionsImpl;
  ...
  @XmlElement(name = "definitions", namespace = CalculatorSchema.NAMESPACE)
  public DefinitionsProperty getDefinitionsProperty() {
    return definitionsImpl == null ? null : new DefinitionsProperty(definitionsImpl);
  }

  public void setDefinitionsProperty(final DefinitionsProperty definitionsProperty) {
    this.definitionsImpl = definitionsProperty.getProperty();
  }
  ...
  public void setDefinitions(final DefinitionsImpl definitions) {
    this.definitionsImpl = definitions;
  }
