 ...
 */
package nl.overheid.aerius.gml.v5_1.collection;
...
import nl.overheid.aerius.gml.v5_1.base.FeatureMemberImpl;
...
import nl.overheid.aerius.gml.v5_1.result.SubPoint;
import nl.overheid.aerius.gml.v5_1.source.EmissionSource;
import nl.overheid.aerius.gml.v5_1.source.farmland.FarmlandEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.lodging.FarmLodgingEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.manure.ManureStorageEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.mobile.OffRoadMobileEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.plan.PlanEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.road.ADMSRoad;
import nl.overheid.aerius.gml.v5_1.source.road.SRM1Road;
import nl.overheid.aerius.gml.v5_1.source.road.SRM1RoadDispersionLine;
import nl.overheid.aerius.gml.v5_1.source.road.SRM2Road;
import nl.overheid.aerius.gml.v5_1.source.ship.InlandShippingEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.ship.MaritimeShippingEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.ship.MooringInlandShippingEmissionSource;
import nl.overheid.aerius.gml.v5_1.source.ship.MooringMaritimeShippingEmissionSource;
...
public class FeatureMemberProperty extends AbstractProperty<FeatureMemberImpl> {
  ...
  @XmlElements({
      ...
      @XmlElement(namespace = CalculatorSchema.NAMESPACE, name = "NcaCustomCalculationPoint", type = NcaCustomCalculationPoint.class),
      @XmlElement(namespace = CalculatorSchema.NAMESPACE, name = "SubPoint", type = SubPoint.class),
