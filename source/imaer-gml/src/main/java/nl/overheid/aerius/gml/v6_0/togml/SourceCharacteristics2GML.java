...
import nl.overheid.aerius.gml.v6_0.source.characteristics.SpecifiedHeatContent;
...
final class SourceCharacteristics2GML {
  ...
  static nl.overheid.aerius.gml.v6_0.source.characteristics.ADMSSourceCharacteristics toGML(
      final ADMSSourceCharacteristics characteristics) throws AeriusException {
    final nl.overheid.aerius.gml.v6_0.source.characteristics.ADMSSourceCharacteristics returnCharacteristics =
        new nl.overheid.aerius.gml.v6_0.source.characteristics.ADMSSourceCharacteristics();
    returnCharacteristics.setBuilding(determineBuilding(characteristics));
  ...
  private static void determineEffluxType(final ADMSSourceCharacteristics characteristics,
      final nl.overheid.aerius.gml.v6_0.source.characteristics.ADMSSourceCharacteristics returnCharacteristics) throws AeriusException {
