...
import nl.overheid.aerius.gml.v2_2.base.FeatureMemberImpl;
import nl.overheid.aerius.gml.v2_2.result.CustomCalculationPoint;
import nl.overheid.aerius.gml.v2_2.result.ReceptorPoint;
import nl.overheid.aerius.gml.v2_2.source.EmissionSource;
import nl.overheid.aerius.gml.v2_2.source.lodging.FarmLodgingEmissionSource;
import nl.overheid.aerius.gml.v2_2.source.mobile.OffRoadMobileEmissionSource;
import nl.overheid.aerius.gml.v2_2.source.plan.PlanEmissionSource;
...
import nl.overheid.aerius.gml.v2_2.source.ship.InlandShippingEmissionSource;
import nl.overheid.aerius.gml.v2_2.source.ship.MaritimeShippingEmissionSource;
import nl.overheid.aerius.gml.v2_2.source.ship.MooringInlandShippingEmissionSource;
import nl.overheid.aerius.gml.v2_2.source.ship.MooringMaritimeShippingEmissionSource;
