...
final class Source2GML implements EmissionSourceVisitor<nl.overheid.aerius.gml.v6_0.source.EmissionSource> {
  ...
  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final GenericEmissionSource emissionSource, final IsFeature feature) {
    return new nl.overheid.aerius.gml.v6_0.source.EmissionSource();
  }

  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final MooringMaritimeShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new MaritimeMooring2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final MaritimeShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new MaritimeRoute2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final InlandShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new InlandRoute2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final MooringInlandShippingEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
  ...
  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final SRM1RoadEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new Road2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final SRM2RoadEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new Road2GML().convert(emissionSource);
  }

  @Override
  public nl.overheid.aerius.gml.v6_0.source.EmissionSource visit(final ADMSRoadEmissionSource emissionSource, final IsFeature feature)
      throws AeriusException {
    return new Road2GML().convert(emissionSource);
  }
