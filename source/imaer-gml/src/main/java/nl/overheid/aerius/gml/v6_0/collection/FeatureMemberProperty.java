 ...
 */
package nl.overheid.aerius.gml.v6_0.collection;
...
import nl.overheid.aerius.gml.v6_0.measure.SRM1RoadMeasureArea;
...
import nl.overheid.aerius.gml.v6_0.source.road.ColdStartEmissionSource;
...
import nl.overheid.aerius.gml.v6_0.source.ship.InlandShippingEmissionSource;
import nl.overheid.aerius.gml.v6_0.source.ship.MaritimeShippingEmissionSource;
import nl.overheid.aerius.gml.v6_0.source.ship.MooringInlandShippingEmissionSource;
import nl.overheid.aerius.gml.v6_0.source.ship.MooringMaritimeShippingEmissionSource;
...
public class FeatureMemberProperty extends AbstractProperty<FeatureMemberImpl> {
  ...
  @XmlElements({
      ...
      @XmlElement(namespace = CalculatorSchema.NAMESPACE, name = "ColdStartEmissionSource", type = ColdStartEmissionSource.class),
