...
public interface IsGmlInlandShippingEmissionSource extends IsGmlEmissionSource {

  GmlEmissionSourceGeometry getEmissionSourceGeometry();

  List<? extends IsGmlProperty<IsGmlInlandShipping>> getInlandShippings();

  IsGmlProperty<IsGmlInlandWaterway> getInlandWaterwayProperty();

  IsGmlReferenceType getMooringA();

  IsGmlReferenceType getMooringB();
