...
import nl.overheid.aerius.gml.v0_5.source.EmissionSourceCharacteristics;
import nl.overheid.aerius.gml.v0_5.source.EmissionSourceCharacteristicsProperty;
...
public class CustomOffRoadMobileSource extends AbstractOffRoadMobileSource implements IsGmlCustomOffRoadMobileSource {
  ...
  public EmissionSourceCharacteristicsProperty getCharacteristicsProperty() {
    return characteristics != null ? new EmissionSourceCharacteristicsProperty(characteristics) : null;
  }

  public void setCharacteristicsProperty(final EmissionSourceCharacteristicsProperty characteristics) {
    this.characteristics = characteristics != null ? characteristics.getProperty() : null;
  }
