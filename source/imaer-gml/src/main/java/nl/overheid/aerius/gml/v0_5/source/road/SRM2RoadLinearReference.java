...
@XmlType(name = "SRM2LinearReferenceType", namespace = CalculatorSchema.NAMESPACE, propOrder = {"freeway", "maximumSpeed", "strictEnforcement",
    "tunnelFactor", "elevation", "elevationHeight", "barrierLeft", "barrierRight"})
