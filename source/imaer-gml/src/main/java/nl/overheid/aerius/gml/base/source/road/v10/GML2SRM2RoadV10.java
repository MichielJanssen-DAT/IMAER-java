 ...
 * which is a version where maximum speed and strict enforcement were on source level instead of vehicle level.
 */
public class GML2SRM2RoadV10<T extends IsGmlSRM2RoadOld> extends GML2SRM2RoadV11<T> {

  /**
   * @param conversionData
   *          The conversion data to use.
   */
  public GML2SRM2RoadV10(final GMLConversionData conversionData) {
