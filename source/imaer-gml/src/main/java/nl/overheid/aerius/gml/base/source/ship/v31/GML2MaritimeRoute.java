 ...
 */
public class GML2MaritimeRoute<T extends IsGmlMaritimeShippingEmissionSource> extends AbstractGML2Specific<T, InlandMaritimeShippingEmissionSource> {
  ...
  @Override
  public InlandMaritimeShippingEmissionSource convert(final T source) throws AeriusException {
    final InlandMaritimeShippingEmissionSource emissionValues = new InlandMaritimeShippingEmissionSource();
    ...
    for (final IsGmlProperty<IsGmlMaritimeShipping> maritimeShippingProperty : source.getMaritimeShippings()) {
      ...
      vesselGroupEmissionValues.setShipCode(maritimeShipping.getCode());
