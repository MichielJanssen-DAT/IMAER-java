...
public class GMLReaderFactoryV60 extends GMLVersionReaderFactory {
   ...
   */
  public GMLReaderFactoryV60(final GMLLegacyCodesSupplier legacyCodesSupplier) throws AeriusException {
    super(legacyCodesSupplier, AeriusGMLVersion.V6_0, CalculatorSchema.NAMESPACE, FeatureCollectionImpl.class);
  }
