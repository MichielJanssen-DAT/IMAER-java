...
import nl.overheid.aerius.gml.v5_1.GMLReaderFactoryV51;
import nl.overheid.aerius.gml.v6_0.GMLReaderFactoryV60;
...
class GMLReaderProxy {
  ...
  public GMLReaderProxy(final GMLLegacyCodesSupplier legacyCodesSupplier) throws AeriusException {
    ...
    factories.add(new GMLReaderFactoryV51(legacyCodesSupplier));
    factories.add(new GMLReaderFactoryV60(legacyCodesSupplier));
  }
