...
public class MooringMaritimeShippingValidator extends MaritimeShippingValidator<MooringMaritimeShipping, MooringMaritimeShippingEmissionSource> {

  MooringMaritimeShippingValidator(final List<AeriusException> errors, final List<AeriusException> warnings,
