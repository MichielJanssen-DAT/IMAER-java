...
public class InlandShippingEmissionSource extends EmissionSourceWithSubSources<InlandShipping> {

  private static final long serialVersionUID = 1L;

  private InlandWaterway waterway;
  ...
  public void setWaterway(final InlandWaterway waterway) {
